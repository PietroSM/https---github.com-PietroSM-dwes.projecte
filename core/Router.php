...
/**
 * S'encarrega de la gestió de rutes dins de l'aplicació.
 * La seua funció es mapear les rutes URL a controladors.
 */
class Router
{
    private $routes;
    ...
    /**
     * Metode responsable d'invocar el metode action d'un controlador
    ...
    /**
     * Determina wue controlador i acció han de ser invocats en la funció de la URI
     * i del metode HTTP
     * @param string $uri
     * @param string $method
     * @return void
    ...
    /**
     * Extrau els parametres de la ruta
     */
    ...
    /**
     * Arxiu de configuració de rutes
     * @param sring $file
     * @return Router
     */
